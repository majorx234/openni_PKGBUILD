...
source=("${_srcprefix}-${pkgver}.tar.gz"::"https://github.com/OpenNI/OpenNI/archive/Stable-${pkgver}.tar.gz"
        ...
        'libopenni.pc'
        "https://github.com/OpenNI/OpenNI/commit/ca99f6181234c682bba42a6ba988cc10cee894d7.patch")
sha256sums=('34b0bbf68633bb213dcb15408f979d5384bdceb04e151fa519e107a12e225852'
            ...
            'b9590b1f366308951daedbc3692ebb0112a1cdff37bc3cf63f2acf5c8569c292')
...
prepare() {
    ...
    dos2unix Include/XnPlatform.h #needed for patch ca99f6181234c682bba42a6ba988cc10cee894d7     
    ...
    patch -Np1 -i "${srcdir}/ca99f6181234c682bba42a6ba988cc10cee894d7.patch" 
}
